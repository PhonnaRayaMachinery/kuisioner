        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="col-lg-12">
			  ...
			  <div class="form-group">
			<label for="inputEmail" class="col-lg-2">Alamat</label>
            <div class="col-lg-12">
              <input type="text" class="form-control" name="">
			  <div class="form-group">
			<label for="inputEmail" class="col-lg-2">No Telepon</label>
            <div class="col-lg-12">
              <input type="number" class="form-control" name="">
          <div class="form-group">
			<label for="inputEmail" class="col-lg-2">Instansi</label>
            <div class="col-lg-12">
              <input type="text" class="form-control" name="">
           <div class="form-group">
			<label for="inputEmail" class="col-lg-2">Nama Barang yang di Beli/Digunakan</label>
            <div class="col-lg-12">
              <input type="text" class="form-control" name="">
